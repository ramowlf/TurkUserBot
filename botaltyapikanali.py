...
async def show_menu(event):
    ...
    menu_text += ".kurt - Kürtlük seviyesini ölçer.\n\n"
    ...
    menu_text += ".beyin - beyinle alakalı birşey dene gör.\n\n"
    ...
    menu_text += "Eklememizi istediğiniz şeyleri @BotAltyapiKanali buraya yazabilirsiniz."
